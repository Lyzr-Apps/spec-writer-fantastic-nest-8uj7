...
function AgentStatusPanel({ activeAgentId }: { activeAgentId: string }) {
  ...
  return (
    <div className="rounded-[0.875rem] border border-border/60 bg-card/80 backdrop-blur-[16px] p-3">
...
// ── Main App ──
export default function SpecDraftApp() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      {/* Agent Status - only visible during processing */}
      {activeAgentId && (
        <div className="fixed bottom-4 left-4 z-50 w-64 opacity-80 transition-opacity hover:opacity-100">
